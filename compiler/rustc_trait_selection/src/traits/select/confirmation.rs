...
impl<'cx, 'tcx> SelectionContext<'cx, 'tcx> {
    ...
    fn confirm_projection_candidate(
        ...
        let candidate = self.infcx.instantiate_binder_with_fresh_vars_skipping_norm(
    ...
    fn confirm_object_candidate(
        ...
        let object_trait_ref = self.infcx.instantiate_binder_with_fresh_vars_skipping_norm(
            obligation.cause.span,
            BoundRegionConversionTime::HigherRankedType,
            object_trait_ref,
        );
        ...
        let upcast_trait_ref = self.infcx.instantiate_binder_with_fresh_vars_skipping_norm(
            obligation.cause.span,
            BoundRegionConversionTime::HigherRankedType,
    ...
    fn equate_trait_refs(
        ...
        let found_trait_ref = self.infcx.instantiate_binder_with_fresh_vars_skipping_norm(
            obligation.cause.span,
            BoundRegionConversionTime::HigherRankedType,
            found_trait_ref,
        );
